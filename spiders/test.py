...
class ZhihuAccount(object):
    ...
    def login(self, username=None, password=None, captcha_lang='en', load_cookies=True):
        ...
        # web_dir = Path.joinpath(Path.cwd(), 'chromedriver')
        # captcha = self._get_captcha(self.login_data['lang'], headers)

        # browser = webdriver.Chrome(executable_path=web_dir)
...
if __name__ == '__main__':
    ...
    account.login(username='15158765640', password='jin630061126', captcha_lang='en', load_cookies=True)